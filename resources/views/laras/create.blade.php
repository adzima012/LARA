        ...
        <div class="bg-gray-800/95 backdrop-blur-sm border border-gray-700 rounded-lg shadow-2xl overflow-hidden">
            ...
            <div class="relative bg-gray-800 border-b border-gray-700 px-8 py-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-serif font-bold text-white mb-2">Wasiat Digital</h1>
            ...
            <div class="p-8 bg-gray-800/90 relative">
                ...
                <form action="{{ route('laras.store') }}" method="POST" class="space-y-8">
                    @csrf

                    <!-- Title field with paper styling -->
                    <div class="relative">
                        <label for="title" class="block text-sm font-medium text-gray-300 mb-3">Judul Wasiat</label>
                        <div class="relative">
                            <input type="text" name="title" id="title" value="{{ old('title') }}" required
                                ...
                                placeholder="Tulis judul wasiat Anda...">
                    ...
                    <!-- Recipient field -->
                    <div class="relative">
                        <label for="penerima_id" class="block text-sm font-medium text-gray-300 mb-3">Penerima Wasiat</label>
                        <div class="relative">
                            <select name="penerima_id" id="penerima_id" required
                                class="w-full px-6 py-4 bg-gray-700/50 border-2 border-gray-600 rounded-lg text-white focus:outline-none focus:border-pink-500/50 focus:bg-gray-700/70 transition-all duration-300 appearance-none cursor-pointer @error('penerima_id') border-red-400/50 @enderror">
                                <option value="" class="text-gray-400">Pilih penerima wasiat...</option>
                                @foreach(\App\Models\User::where('id', '!=', auth()->id())->get() as $user)
                                    <option value="{{ $user->id }}" {{ old('penerima_id') == $user->id ? 'selected' : '' }} class="text-white">
                    ...
                    <div class="relative">
                        <label for="content" class="block text-sm font-medium text-gray-300 mb-3">Isi Wasiat</label>
                        <div class="relative">
                            ...
                            <div class="text-sm text-gray-300">
                                ...
                                <ul class="space-y-2 text-gray-300">
                                    <li class="flex items-start">
                                        ...
                                        Wasiat Anda akan tetap rahasia hingga dibuka oleh admin
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-pink-400 mr-2">•</span>
                                        Hanya penerima yang ditentukan yang dapat melihat wasiat setelah dibuka
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-pink-400 mr-2">•</span>
                                        Anda dapat mengedit atau menghapus wasiat ini kapan saja sebelum dibuka
                                    </li>
                                    <li class="flex items-start">
                                        <span class="text-pink-400 mr-2">•</span>
